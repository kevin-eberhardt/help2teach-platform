    ...
    return (
      <main className="p-4 container mx-auto">
        ...
        <p>
          ...
          &quot;Information on the Responsible Party&quot; in this privacy
          policy.
        </p>
        ...
        <p>
          ...
          the user&apos;s device (e.g., device fingerprinting) within the
        ...
        <p>
          ...
          the fact that the address bar of the browser changes from
        ...
        <p>
          ...
          packets that do not cause any harm to your device. They are either
          stored temporarily for the duration of a session (session cookies) or
        ...
        <p>
          ...
          (&quot;Google&quot;). Google Tag Manager is used to manage website
          tags through an interface. The Google Tag Manager itself does not
          collect any personal data. It simply implements tags for other
          services (such as Google Analytics), which may collect personal data
          on their own.
        </p>
        <p>
        ...
        <p>
          ...
          uses &quot;cookies&quot;. These are small text files that your web
          browser stores on your device and that enable an analysis of website
          usage. Information generated by cookies about your use of our website
          is transmitted to and stored on a Google server. The usual server
          location is the USA.
        </p>
        ...
        <p>
          Our website uses the &quot;demographic features&quot; function of
          Google Analytics. This allows reports to be generated containing
          information about the age, gender, and interests of website visitors.
          This data comes from Google’s interest-based advertising as well as
          visitor data from third-party providers. The data cannot be attributed
    ...
    return (
      <main className="p-4 container mx-auto">
        ...
        <p>
          ...
          Google LLC (&quot;Google&quot;). Der Google Tag Manager dient zur
          Verwaltung von Website-Tags über eine Oberfläche. Der Google Tag
          Manager selbst erfasst keine personenbezogenen Daten. Es werden
          lediglich Tags für andere Dienste (wie Google Analytics)
          implementiert, die ihrerseits möglicherweise personenbezogene Daten
          erheben.
        </p>
        <p>
        ...
        <p>
          ...
          Amphitheatre Parkway, Mountain View, CA 94043, USA. Google Analytics
          verwendet &quot;Cookies.&quot; Das sind kleine Textdateien, die Ihr
          ...
          USA. Das Setzen von Google-Analytics-Cookies erfolgt auf Grundlage von
        ...
        <p>
          ...
          erstellen, die Aussagen zu Alter, Geschlecht und Interessen der
          Seitenbesucher enthalten. Diese Daten stammen aus interessenbezogener
          Werbung von Google sowie aus Besucherdaten von Drittanbietern. Eine
          Zuordnung der Daten zu einer bestimmten Person ist nicht möglich. Sie
          können diese Funktion jederzeit deaktivieren. Dies ist über die
          Anzeigeneinstellungen in Ihrem Google-Konto möglich oder indem Sie die
